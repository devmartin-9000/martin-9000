...
const NavBar = () => {
	...
	return (
		<nav className="fixed top-0 left-0 p-2 w-full dark:bg-background/50 backdrop-blur-2xl shadow-md z-50">
			<div className="dark:border dark:border-white/10 flex items-center justify-between dark:bg-background/20 bg-black opacity-80 backdrop-blur-2xl rounded-2xl px-4 py-0 md:max-w-6xl mx-auto">
				...
				<Link to="/">
					<div className="flex items-center p-2 gap-3 cursor-pointer">
						<img
							...
							loading="lazy"
						/>
						<h1 className="font-bold text-white/80 text-2xl md:text-3xl hover:scale-105 transition-transform duration-200 ease-in-out">
							.martin
						</h1>
					</div>
				</Link>
