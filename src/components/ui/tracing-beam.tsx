		...
		>
			...
			<div className="hidden xl:block absolute top-3 -left-4 md:-left-20">
				<motion.div
					...
					className="border-accent ml-[27px] flex h-4 w-4 items-center justify-center rounded-full border shadow-sm"
				>
					<motion.div
						transition={{
							duration: 0.2,
						...
						className="h-2 w-2 rounded-full border border-accent bg-white"
					/>
				</motion.div>
				...
				>
					...
					<defs>
						<motion.linearGradient
							...
							y2={y2}
						>
							<stop stopColor="#cfe718" stopOpacity="0"></stop>
							<stop stopColor="#cfe718"></stop>
							<stop offset="0.325" stopColor="#cfe718"></stop>
							<stop offset="1" stopColor="#cfe718" stopOpacity="0"></stop>
						</motion.linearGradient>
					</defs>
				</svg>
			</div>
