			...
			<div className="flex flex-col gap-4">
				...
				<div className="bg-primary rounded-4xl p-2 md:p-10 flex flex-col md:flex-row gap-8 shadow-xl">
					...
					<div className="bg-background text-muted-foreground rounded-4xl p-6 md:p-10 w-full md:w-1/2">
						<h2 className="text-primary-foreground opacity-90 text-lg md:text-xl font-bold mb-4 text-center">
							Project Summary
						</h2>

						<p className="text-sm leading-snug mb-4">
							This platform aims to be that simple fun tool businesses and
							freelancers can use to generate styled invoices with ease. Without
							having to download an app on their phone or computer.
						</p>

						<p className="text-sm leading-snug mb-4">
							The problem it solves, is the struggle of having to manually fill
							out repetitive information for every client that needs an invoice,
							things like, product/services rendered, payment information etc.
							This system makes the entire process simple and effortless.
						</p>

						<p className="text-sm leading-relaxed">
							I collaborated with fellow developers who took care of the backend
							and business logic, while I took full ownership of the front-end;
							landing page, dashboards and layouts.
						</p>
					</div>
				</div>
				{/* HOOKLAB BLOCK */}
				<div className="bg-primary rounded-4xl p-2 md:p-10 flex flex-col-reverse md:flex-row gap-8 shadow-xl">
					...
					<div className="bg-background text-muted-foreground rounded-4xl p-6 md:p-10 w-full md:w-1/2">
						...
						<p className="text-sm leading-snug mb-4">
							...
							advertisers who want to see exactly how their ad hooks will appear
							across different platforms and devices, before spending a single
							dollar on campaigns.
						</p>

						<p className="text-sm leading-snug mb-4">
							It solves the uncertainty that comes with launching new creatives.
							Instead of guessing how your ad will look on mobile feeds, desktop
							layouts, or story placements, HookLab provides an instant,
							accurate visual preview so teams can iterate faster and make
							confident decisions.
						</p>
					...
					<div className="bg-primary border border-background rounded-4xl p-3 md:p-5 w-full md:w-1/2">
						...
						{/* TITLE */}
						<p className="mt-4 text-muted text-center font-semibold text-sm mb-3">
							<span className="font-bold">Hooklab</span> – A platform to preview
							your ad hooks across multiple platforms
						</p>
						<Separator />
